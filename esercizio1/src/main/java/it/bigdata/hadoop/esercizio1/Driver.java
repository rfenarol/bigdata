...
public class Driver {
	public static void main(String[] args) throws Exception {
		...
		job.waitForCompletion(true); // Submit the job to the cluster and wait
										// for it to finish.
										// Se il parametro √® true, print the
										// progress to the user

		/*
		 * Secondo me la soluzione per fare l'ordinamento Ë questa: 
		 * 1 Chaining MapReduce jobs in a sequence 
		 * Though you can execute the two jobs
		 * manually one after the other, itís more convenient to automate the
		...
		//
		// job2.setMapperClass(Mapper.class); //questo mapper dovr√† solo
